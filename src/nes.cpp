...
nes_t *nes_create(void)
{
   ...
   machine = (nes_t *)malloc(sizeof(nes_t));
   if (NULL == machine)
      return NULL;
   ...
   /* cpu */
   // Gil
   machine->cpu = (nes6502_context*)malloc(sizeof(nes6502_context));
   if (NULL == machine->cpu)
      goto _fail;
   ...
   /* allocate 2kB RAM */
   machine->cpu->mem_page[0] = (uint8*)malloc(NES_RAMSIZE);
